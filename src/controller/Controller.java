...
public class Controller {
	...
	public void GA(int size_pop, int iters,
		...
		Crossover[] metCross = {new ContinuousCrossover(prob_cross), new StandardCrossover(prob_cross)};
		Mutation[] metMut = {new ExtraTestMutation(prob_mut, totalTests), new ReplaceMutation(prob_mut, totalTests)};
